...
def parse_args():
    ...
    parser.add_argument('config', default="projects/configs/toponet_r50_8x1_24e_olv2_subset_A.py", help='test config file path')
    parser.add_argument('checkpoint', default="checkpoints/latest.pth", help='checkpoint file')
    ...
    parser.add_argument(
        '--out-dir', default="work_dirs/alpha/test", help='directory where results will be saved')
    parser.add_argument(
        '--gpu-collect',
        action='store_true',
