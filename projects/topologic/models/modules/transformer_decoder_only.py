...
class TopoLogicTransformerDecoderOnly(BaseModule):
    ...
    def __init__(self,
                 ...
                 pts_dim=3,
                 **kwargs):
        super(TopoLogicTransformerDecoderOnly, self).__init__(**kwargs)
    ...
    def forward(self,
        ...
        inter_states, inter_references, inter_lclc_rel, inter_lcte_rel, outputs_coords = self.decoder(
            query=query,
            key=None,
            value=bev_embed,
            query_pos=query_pos,
        ...
        return inter_states, init_reference_out, inter_references_out, inter_lclc_rel, inter_lcte_rel,outputs_coords
